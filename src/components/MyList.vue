    ...
    <div class="col-md-6">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="card-sub">
            Add
            <code class="highlighter-rouge">.table-striped</code> to rows the
            striped table
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="card-sub">
            ...
            <code class="highlighter-rouge">DIV</code> to make them scroll
    ...
    <div class="col-md-6">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="card-sub">
            Add
            <code class="highlighter-rouge">.table-bordered</code> to create a
            bordered table
          </div>
          <table class="table table-bordered">
            <thead>
          ...
          <div class="card-sub">
            ...
            so that the table header has the same color as the border color of
            the table
          </div>
          <table
